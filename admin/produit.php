...
<body>
    <div class="container">
        ...
        <div class="bougie">
            <button class="add"><a href="#form_bougie">
        ...
        <div class="fondant" style="display:none;">
            <button class="add"><a href="#form_fondant">
                    <ion-icon size="large" name="add-circle-outline"></ion-icon>
                </a></button>
            <?php
        ...
        <div class="fiole" style="display:none;">
            <button class="add"><a href="#form_fiole">
                    <ion-icon size="large" name="add-circle-outline"></ion-icon>
                </a></button>
            <?php
        ...
        <div class="brume" style="display:none;">
            <button class="add"><a href="#form_brume">
                    <ion-icon size="large" name="add-circle-outline"></ion-icon>
                </a></button>
            <?php
        ...
        <script src="../js/update_fondant.js"></script>
</body>
